...
export const fetchInfo = () => dispatch => {
    ...
    fetch(`https://good-morning-sarah.herokuapp.com/https://api.wunderground.com/api/${process.env.REACT_APP_WEATHER_KEY}/conditions/q/CA/San_Francisco.json`, fetchMixins)
        .then(res => res.json())
        .then(res => {
console.log(res)
        })
